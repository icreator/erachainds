...
public class fe_invert {
    ...
    public static void fe_invert(int[] out, int[] z) {
        ...
        fe_sq.fe_sq(t0, z);
        for (i = 1; i < 1; ++i) fe_sq.fe_sq(t0, t0);
        ...
        fe_sq.fe_sq(t2, t0);
        for (i = 1; i < 1; ++i) fe_sq.fe_sq(t2, t2);
        ...
        fe_sq.fe_sq(t2, t1);
        for (i = 1; i < 5; ++i) fe_sq.fe_sq(t2, t2);
        ...
        fe_sq.fe_sq(t2, t1);
        for (i = 1; i < 10; ++i) fe_sq.fe_sq(t2, t2);
        ...
        fe_sq.fe_sq(t3, t2);
        for (i = 1; i < 20; ++i) fe_sq.fe_sq(t3, t3);
        ...
        fe_sq.fe_sq(t2, t1);
        for (i = 1; i < 50; ++i) fe_sq.fe_sq(t2, t2);
        ...
        fe_sq.fe_sq(t3, t2);
        for (i = 1; i < 100; ++i) fe_sq.fe_sq(t3, t3);
